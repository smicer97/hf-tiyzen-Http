...
namespace RobotBrain.State
{
    public abstract class DistanceBasedTurningStateBase : StateBase
    {
        ...
        protected LineAndWallDetectorRobot Robot => this.Brain.Brain as LineAndWallDetectorRobot;
        ...
        {
            if (this.Brain.Brain.Speed < TargetSpeed)
                this.Brain.Brain.Acceleration = 1.0;
            else
                this.Brain.Brain.Acceleration = 0.0;
        }
    }
}
*/